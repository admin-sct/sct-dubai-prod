...
import chemicalDeliverySystemsData from '../data/chemical-delivery-systems.json';

const ChemicalDeliverySystemsPage = () => {
  const [searchTerm, setSearchTerm] = React.useState('');

  const filteredProducts = chemicalDeliverySystemsData.filter(product =>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-6 items-center justify-between">
            ...
            <div className="relative flex-1 max-w-md">
              ...
              <input
                type="text"
                placeholder="Search chemical delivery systems..."
                value={searchTerm}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">
              Our Chemical Delivery Systems Collection
            </h2>
          ...
          {filteredProducts.length === 0 && (
            <div className="text-center py-16">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-2">No chemical delivery systems found</h3>
