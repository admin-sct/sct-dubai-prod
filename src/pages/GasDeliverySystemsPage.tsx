...
import gasDeliverySystemsData from '../data/gas-delivery-systems.json';

const GasDeliverySystemsPage = () => {
  const [searchTerm, setSearchTerm] = React.useState('');

  const filteredProducts = gasDeliverySystemsData.filter(product =>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-6 items-center justify-between">
            ...
            <div className="relative flex-1 max-w-md">
              ...
              <input
                type="text"
                placeholder="Search gas delivery systems..."
                value={searchTerm}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">
              Our Gas Delivery Systems Collection
            </h2>
          ...
          {filteredProducts.length === 0 && (
            <div className="text-center py-16">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-2">No gas delivery systems found</h3>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-green-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto">
            Our engineering team can design and implement complete gas delivery systems tailored to your specific requirements
          </p>
