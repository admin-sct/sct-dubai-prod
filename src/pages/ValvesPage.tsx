...
const ValvesPage = () => {
  ...
  const filteredProducts = valvesData.filter(product =>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
              Control <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-green-400">Valves</span>
            </h1>
            <p className="text-xl md:text-2xl text-white/90 max-w-4xl mx-auto leading-relaxed">
              Advanced control valves for precise flow regulation in critical industrial applications
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {filteredProducts.length === 0 && (
            <div className="text-center py-16">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-2">No valves found</h3>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-green-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto">
            Our technical experts can help you select the perfect valves for your specific requirements
          </p>
